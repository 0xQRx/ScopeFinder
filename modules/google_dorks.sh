...
# additional:
# Google Dork - Cloud File Shares ☁️
...
# example:
# https://www.google.com/search?q=site%3A0qx.cc+intext%3A%22choose+file%22+%7C+intext%3A%22select+file%22+%7C+intext%3A%22upload+PDF%22

# https://www.google.com/search?q=site:0qx.cc intext:"choose file" | intext:"select file" | intext:"upload PDF"