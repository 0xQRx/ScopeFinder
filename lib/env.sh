...
init_dirs() {
    ...
    DIRS[URLS_LINKFINDER]="${domain}/urls/linkfinder"
...
declare -A FILES=(
    ...
    [SUBDOMAINS_200]="200_subdomains.txt"
    [REDIRECTED_TO_SUBDOMAINS]="redirected_to_subdomains.txt"
    [WILDCARD_SUBDOMAINS]="wildcard_subdomains.txt"
    [EMAILS]="emails.txt"
    [LEAKED_EMAIL_PASSWD]="leaked_email_passwd.txt"
    [LEAKED_USERNAME_PASSWD]="leaked_username_passwd.txt"
    [WAYMORE_URLS_WITH_PARAMS]="waymore_urls_with_params.txt"
    [WAYMORE_URLS_WITHOUT_PARAMS]="waymore_urls_without_params.txt"
    ...
    [IPS_FROM_SMAP]="ips_from_smap.txt"
